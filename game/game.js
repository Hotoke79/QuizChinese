const welcome = `Hello and welcome to the quiz
Here will be the riddle to an idiom displayed
Tap the field to reveal the answer`
const backward = `To start the game please select a category in side menu`
...
descr.innerHTML = welcome
const reveal = document.createElement('div')
reveal.setAttribute("id", "reveal")
reveal.innerHTML = backward
